...
public class Vm {
    ...
    public native boolean step(Callback cb) throws SpatialiteException;
    ...
    public native boolean compile() throws SpatialiteException;

    /**
     * Abort the compiled SQLite VM.
     */

    public native void stop() throws SpatialiteException;
