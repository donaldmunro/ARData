...
public class Database {
     ...
     * @throws SpatialiteException
     */

    public void open( String filename, int mode ) throws SpatialiteException
    {
    ...
    public void open( String filename, int mode, String vfs ) throws SpatialiteException
    {
        this.filename = filename;
        if ((mode & 0200) != 0) {
            mode = jsqlite.Constants.SQLITE_OPEN_READWRITE | jsqlite.Constants.SQLITE_OPEN_CREATE;
    ...
    public void open( String filename, int mode, String vfs, boolean ver2 ) throws SpatialiteException
    {
        this.filename = filename;
        if ((mode & 0200) != 0) {
            mode = jsqlite.Constants.SQLITE_OPEN_READWRITE | jsqlite.Constants.SQLITE_OPEN_CREATE;
    ...
    private native void _open( String filename, int mode ) throws SpatialiteException;

    /*
     * Newer full interface
     */

    private native void _open4( String filename, int mode, String vfs, boolean ver2 ) throws SpatialiteException;
    ...
    public void open_aux_file( String filename ) throws SpatialiteException
    {
        synchronized (this) {
    ...
    private native void _open_aux_file( String filename ) throws SpatialiteException;
    ...
    public void close() throws SpatialiteException
    {
        synchronized (this) {
            _close();
        }
    ...
    private native void _close() throws SpatialiteException;
    ...
    public void exec( String sql, jsqlite.Callback cb ) throws SpatialiteException
    {
        synchronized (this) {
            _exec(sql, cb);
        }
    ...
    private native void _exec( String sql, jsqlite.Callback cb ) throws SpatialiteException;
    ...
    public void exec( String sql, jsqlite.Callback cb, String args[] ) throws SpatialiteException
    {
        synchronized (this) {
            _exec(sql, cb, args);
        }
    ...
    private native void _exec( String sql, jsqlite.Callback cb, String args[] ) throws SpatialiteException;
    ...
    public TableResult get_table( String sql, int maxrows ) throws SpatialiteException
    {
    ...
    public TableResult get_table( String sql ) throws SpatialiteException
    {
    ...
    public TableResult get_table( String sql, int maxrows, String args[] ) throws SpatialiteException
    {
        TableResult ret = new TableResult(maxrows);
        if (!is3()) {
            try {
    ...
    public TableResult get_table( String sql, String args[] ) throws SpatialiteException
    {
    ...
    public void get_table( String sql, String args[], TableResult tbl ) throws SpatialiteException
    {
        tbl.clear();
        if (!is3()) {
            try {
    ...
    public void set_encoding( String enc ) throws SpatialiteException
    {
        synchronized (this) {
            _set_encoding(enc);
        }
    ...
    private native void _set_encoding( String enc ) throws SpatialiteException;
    ...
    public Backup backup( Database dest, String destName, String srcName ) throws SpatialiteException
    {
        synchronized (this) {
            Backup b = new Backup();
    ...
    public Vm compile( String sql ) throws SpatialiteException
    {
        synchronized (this) {
            Vm vm = new Vm();
            vm_compile(sql, vm);
    ...
    public Vm compile( String sql, String args[] ) throws SpatialiteException
    {
        synchronized (this) {
            Vm vm = new Vm();
    ...
    public Stmt prepare( String sql ) throws SpatialiteException
    {
        synchronized (this) {
            Stmt stmt = new Stmt();
    ...
    public Blob open_blob( String db, String table, String column, long row, boolean rw ) throws SpatialiteException
    {
        synchronized (this) {
            Blob blob = new Blob();
    ...
    private native void vm_compile( String sql, Vm vm ) throws SpatialiteException;
    ...
    private native void vm_compile_args( String sql, Vm vm, String args[] ) throws SpatialiteException;
    ...
    private native void stmt_prepare( String sql, Stmt stmt ) throws SpatialiteException;
    ...
    public void key( byte[] ekey ) throws SpatialiteException
    {
        synchronized (this) {
            _key(ekey);
        }
    ...
    public void key( String skey ) throws SpatialiteException
    {
        synchronized (this) {
            byte ekey[] = null;
    ...
    public void rekey( byte[] ekey ) throws SpatialiteException
    {
        synchronized (this) {
            _rekey(ekey);
        }
    ...
    public void rekey( String skey ) throws SpatialiteException
    {
        synchronized (this) {
            byte ekey[] = null;
            if (skey != null && skey.length() > 0) {
    ...
    public static long long_from_julian( String s ) throws SpatialiteException
    {
        try {
            double d = Double.valueOf(s).doubleValue();
            return long_from_julian(d);
        } catch (java.lang.Exception ee) {
            throw new SpatialiteException("not a julian date: " + s + ": " + ee);
        }
    }
