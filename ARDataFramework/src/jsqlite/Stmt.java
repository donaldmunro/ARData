...
public class Stmt {
    ...
    public native boolean prepare() throws SpatialiteException;
    ...
    public native boolean step() throws SpatialiteException;

    /**
     * Close the compiled SQLite3 statement.
     */

    public native void close() throws SpatialiteException;
    ...
    public native void reset() throws SpatialiteException;

    /**
     * Clear all bound parameters of the compiled SQLite3 statement.
     */

    public native void clear_bindings() throws SpatialiteException;
    ...
    public native void bind(int pos, int value) throws SpatialiteException;
    ...
    public native void bind(int pos, long value) throws SpatialiteException;
    ...
    public native void bind(int pos, double value) throws SpatialiteException;
    ...
    public native void bind(int pos, byte[] value) throws SpatialiteException;
    ...
    public native void bind(int pos, String value) throws SpatialiteException;
    ...
    public native void bind(int pos) throws SpatialiteException;
    ...
    public native int bind_parameter_count() throws SpatialiteException;
    ...
    public native String bind_parameter_name(int pos) throws SpatialiteException;
    ...
    public native int column_int(int col) throws SpatialiteException;
     ...
     */
    public native long column_long(int col) throws SpatialiteException;
     ...
     */
    public native double column_double(int col) throws SpatialiteException;
     ...
     */
    public native byte[] column_bytes(int col) throws SpatialiteException;
     ...
     */
    public native String column_string(int col) throws SpatialiteException;
     ...
     */
    public native int column_type(int col) throws SpatialiteException;
    ...
    public native int column_count() throws SpatialiteException;
    ...
    public Object column(int col) throws SpatialiteException
    {
    ...
    public native String column_table_name(int col) throws SpatialiteException;
    ...
    public native String column_database_name(int col) throws SpatialiteException;
    ...
    public native String column_decltype(int col) throws SpatialiteException;
    ...
    public native String column_name(int col) throws SpatialiteException;
    ...
    public native String column_origin_name(int col) throws SpatialiteException;
